        ...
        $('button[data-label="Pay%20Invoice"]').prop('disabled', true);
            ...
            frappe.call({
                ...
                callback: function(response) {
                    ...
                    frappe.call({
                        method: "erpnext_payement.erpnext_payement.payement.getPayementData",
                        args: {
                        ...
                        callback: function(response) {
                            ...
                            frappe.call({
                                method: "erpnext_payement.erpnext_payement.payement.payInvoice",
                                args: {
                                    secKey:  sec_key,
                                ...
                                callback: function(response) {
                                    ...
                                    if(res.error==1){
                                        frappe.call({
                                            method: "erpnext_payement.erpnext_payement.payement.updatePaymentMethod",
                                            args: {
        ...
        $('button[data-fieldname = "add"]').click(function(e) {
            ...
            frappe.call({
                ...
                callback: function(response) {
                    ...
                    frappe.call({
                        method: "erpnext_payement.erpnext_payement.payement.addPaymentCard",
                        args: {
                            name:name, 
                            number:number, 
